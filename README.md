...
**Principais recursos:**
- Criação e acompanhamento de tickets de atendimento.  
- Atribuição de responsáveis e controle de status.  
- Histórico completo das atualizações de cada ticket.  
...
| Camada | Tecnologias |
|:-------|:-------------|
| **Frontend (Site)** | HTML5, CSS3, JavaScript |
| **Design / Identidade Visual** | Figma, ícones SVG, Google Fonts (Teko e Open Sans) |
| **Backend (Aplicativo de Gestão)** | Java (Regras de Negócio e POO), Python (Análises e Dashboards) |
...
| Elemento | Descrição |
|-----------|------------|
| 🪪 **Logo** | Representa movimento e inovação, inspirada no símbolo de avanço (“>>”). |
| 🎨 **Paleta** | Combinação entre tons de azul e roxo, transmitindo confiança e criatividade. |
| 🔠 **Fontes** | Teko (títulos) e Open Sans (textos). |
| 🧭 **Ícones** | SVGs minimalistas e coerentes com o design moderno. |
